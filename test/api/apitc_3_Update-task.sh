...
# TITLE         : Update the label of an exiting task.
# OBJECTIVE     : Verify that an existing task can be updated via the API.
# STATUS        : Ready
# LEVEL         : System
# TYPE          : Requirement
# REFERENCE     : Req7, tc_1
...
echo "===== TEST EXECUTION ====="
task_name="api testcase 3"
expected_result="api testcase 3"

# Test Execute
curl -d "edittodo=$task_name" http://$URL:$PORT/todo/edit/0 >> $REPORTFILENAME
